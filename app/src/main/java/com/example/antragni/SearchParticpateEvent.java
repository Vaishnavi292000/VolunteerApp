    ...
    public  void Participate()
    {
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                 ...
                 * */
                params.put("eid",id);
                params.put("lid",new LoginManager(SearchParticpateEvent.this).getUserDetails().get(LoginManager.KEY_ID));
                params.put("name",new LoginManager(SearchParticpateEvent.this).getUserDetails().get(LoginManager.KEY_NAME));
                params.put("mobile",new LoginManager(SearchParticpateEvent.this).getUserDetails().get(LoginManager.KEY_CONTACT_NUMBER));
